...
#define GBC_APU_SAMPLE_RATE 209     // In CPU ticks
#define GBC_APU_BUFFER_SIZE 336 * 2 // Samples per frame doubled due to double buffering. Must be (70224 / GBC_APU_SAMPLE_RATE) * 2
