...
void SDC_Initialize()
{
    // Enable peripheral and DMA1 controller clock using 
    ...
    SDIO_InitObject.SDIO_ClockDiv = 0x00;
    ...
    SDIO_InitObject.SDIO_BusWide = SDIO_BusWide_4b;
    SDIO_InitObject.SDIO_HardwareFlowControl = SDIO_HardwareFlowControl_Disable;
    SDIO_Init(&SDIO_InitObject);

    // Enable SD I/O interrupt received interrupt and corresponding NVIC
