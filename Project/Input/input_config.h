...
#define INPUT_A_PIN                         GPIO_Pin_0
#define INPUT_A_EXTI_PORT                   EXTI_PortSourceGPIOA
#define INPUT_A_EXTI_PIN                    EXTI_PinSource0
#define INPUT_A_EXTI_LINE                   EXTI_Line0
#define INPUT_A_NVIC_CHANNEL                EXTI0_IRQn

#define INPUT_B_PORT                        GPIOA
#define INPUT_B_PIN                         GPIO_Pin_4
...
#define INPUT_START_EXTI_PORT               EXTI_PortSourceGPIOA
#define INPUT_START_EXTI_PIN                EXTI_PinSource2
#define INPUT_START_EXTI_LINE               EXTI_Line2
#define INPUT_START_NVIC_CHANNEL            EXTI2_IRQn

#define INPUT_SELECT_PORT                   GPIOA
#define INPUT_SELECT_PIN                    GPIO_Pin_3
#define INPUT_SELECT_EXTI_PORT              EXTI_PortSourceGPIOA
#define INPUT_SELECT_EXTI_PIN               EXTI_PinSource3
#define INPUT_SELECT_EXTI_LINE              EXTI_Line3
#define INPUT_SELECT_NVIC_CHANNEL           EXTI3_IRQn

#define INPUT_FADE_TOP_PORT                 GPIOA
#define INPUT_FADE_TOP_PIN                  GPIO_Pin_5
#define INPUT_FADE_TOP_EXTI_PORT            EXTI_PortSourceGPIOA
...
#define INPUT_FADE_RIGHT_PORT               GPIOA
#define INPUT_FADE_RIGHT_PIN                GPIO_Pin_6
#define INPUT_FADE_RIGHT_EXTI_PORT          EXTI_PortSourceGPIOA
...
#define INPUT_FADE_BOTTOM_PORT              GPIOA
#define INPUT_FADE_BOTTOM_PIN               GPIO_Pin_7
#define INPUT_FADE_BOTTOM_EXTI_PORT         EXTI_PortSourceGPIOA
...
#define INPUT_FADE_LEFT_PORT                GPIOA
#define INPUT_FADE_LEFT_PIN                 GPIO_Pin_8
#define INPUT_FADE_LEFT_EXTI_PORT           EXTI_PortSourceGPIOA
