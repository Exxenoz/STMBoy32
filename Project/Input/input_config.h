...
#define INPUT_FRAME_PORT                    GPIOD
#define INPUT_FRAME_PIN                     GPIO_Pin_0
#define INPUT_FRAME_EXTI_PORT               EXTI_PortSourceGPIOD
...
#define INPUT_START_EXTI_PORT               EXTI_PortSourceGPIOD
...
#define INPUT_SELECT_EXTI_PORT              EXTI_PortSourceGPIOD
...
#define INPUT_FADE_TOP_EXTI_PORT            EXTI_PortSourceGPIOD
...
#define INPUT_FADE_RIGHT_EXTI_PORT          EXTI_PortSourceGPIOD
...
#define INPUT_FADE_BOTTOM_PORT              GPIOD
#define INPUT_FADE_BOTTOM_PIN               GPIO_Pin_7
#define INPUT_FADE_BOTTOM_EXTI_PORT         EXTI_PortSourceGPIOD
...
#define INPUT_FADE_LEFT_EXTI_PORT           EXTI_PortSourceGPIOD
