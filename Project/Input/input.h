...
typedef enum INPUT_InterruptFlags_e
{
    ...
    INPUT_INTERRUPT_FLAG_START       = 0x0008,
    INPUT_INTERRUPT_FLAG_SELECT      = 0x0010,
    INPUT_INTERRUPT_FLAG_FADE_TOP    = 0x0020,
    INPUT_INTERRUPT_FLAG_FADE_RIGHT  = 0x0040,
    INPUT_INTERRUPT_FLAG_FADE_LEFT   = 0x0080,
...
extern uint32_t INPUT_INTERRUPT_FLAGS;
