...
#define SDRAM_READ_BYTE(INTERN_ADDR, BYTE)       (BYTE  = (*(__IO uint8_t*)  (SDRAM_BANK_ADDR + WRITE_READ_ADDR + INTERN_ADDR)))
#define SDRAM_READ_SHORT(INTERN_ADDR, BYTES)     (BYTES = (*(__IO uint16_t*) (SDRAM_BANK_ADDR + WRITE_READ_ADDR + INTERN_ADDR)))
#define SDRAM_READ_LONG(INTERN_ADDR, BYTES)      (BYTES = (*(__IO uint32_t*) (SDRAM_BANK_ADDR + WRITE_READ_ADDR + INTERN_ADDR)))
