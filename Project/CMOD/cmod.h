...
#define CMOD_RST_RESET       CMOD_RESET_PORT->BSRRL |= CMOD_RESET_PIN
#define CMOD_SET_RESET       CMOD_RESET_PORT->BSRRH |= CMOD_RESET_PIN
                             
#define CMOD_RST_CS          CMOD_CS_PORT->BSRRL |= CMOD_CS_PIN
#define CMOD_SET_CS          CMOD_CS_PORT->BSRRH |= CMOD_CS_PIN
                             
#define CMOD_RST_RD          CMOD_RD_PORT->BSRRL |= CMOD_RD_PIN
#define CMOD_SET_RD          CMOD_RD_PORT->BSRRH |= CMOD_RD_PIN
                             
#define CMOD_RST_WR          CMOD_WR_PORT->BSRRL |= CMOD_WR_PIN
#define CMOD_SET_WR          CMOD_WR_PORT->BSRRH |= CMOD_WR_PIN
